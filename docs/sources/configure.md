...
| **URI** | The URI of your MQTT broker. Include the scheme and port. Supported schemes: `tcp://` (unencrypted), `tls://` (TLS-encrypted), and `ws://` (WebSocket). For example, `tcp://localhost:1883` or `tls://broker.example.com:8883`. |
